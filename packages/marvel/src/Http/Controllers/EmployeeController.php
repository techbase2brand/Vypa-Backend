...
class EmployeeController extends CoreController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->fetchEmployees($request)->paginate($limit)->withQueryString();
    }

    public function fetchEmployees(Request $request)
    {
        return $this->repository->withCount(['orders'])->where('id', '!=', null);
    }
     ...
     * @return mixed
     */
    public function store(EmployeeCreateRequest $request): mixed
    {
        try {
    ...
    public function EmployeeRegister(EmployeeCreateRequest $request)
    {
        try {
            return $this->repository->storeEmployee($request);
